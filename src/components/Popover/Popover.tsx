...
import { arrow, FloatingPortal, offset, shift, type Placement } from '@floating-ui/react-dom-interactions'
...
const Popover = ({ children, renderPopover, initialOpen, placement }: PopoverProps) => {
